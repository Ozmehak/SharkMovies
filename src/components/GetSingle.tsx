    ...
    return (
        ...
        <Tabs fill defaultActiveKey="info" style={{backgroundColor: "#131516"}}>
            ...
            <Tab eventKey="images" title="Images">
                <Modal.Body className="show-grid" style={{backgroundColor: "#131516", color: "#fff"}}><Container><Row>Lorem ipsum dolor sit amet, consectetur
                    ...
                    fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</Row></Container>
                </Modal.Body></Tab>
